...
public class main {
	...
	public static void main(String[] args) {
		...
		System.out.print("Course code/type: ");
		...
		if(answer.equalsIgnoreCase("y")) {
			...
			try {
				...
				course.setCourse(crs);

				courses.put(ct,course);
		...
		case 1: 
			...
			do {	
				...
				if(a.equalsIgnoreCase("a")) {	
					...
					Scanner choice1 = new Scanner(System.in);
					String val = choice1.nextLine();
					System.out.print("Enter its code/type: ");
					String val1 = choice1.nextLine();
